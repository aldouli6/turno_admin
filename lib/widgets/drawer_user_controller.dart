...
class _DrawerUserControllerState extends State<DrawerUserController> with TickerProviderStateMixin {
  ...
  @override
  void initState() {
    animationController = AnimationController(duration: const Duration(milliseconds: 2000) );
    iconAnimationController = AnimationController( duration: const Duration(milliseconds: 0));
              ...
              SizedBox(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(color: AppSettings.PRIMARY.withOpacity(0.6), blurRadius: 24),
                    ],
                  ),
                  child: Stack(
                    children: <Widget>[
